...
class ForgotPasswordController extends Controller
{
    ...
    public function sendCode(Request $request)
    {
        ...
        return redirect()->route('user.password.forgot.code.verify.form',$token)->with(['success' => [__("Verification code send success")]]);
    }
    ...
    public function resetPassword(Request $request,$token) {
        ...
        return redirect()->route('index')->with(['success' => [__('Password reset success. Please login with new password')]]);
    }
