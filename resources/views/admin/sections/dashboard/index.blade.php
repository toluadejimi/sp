                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{  get_default_currency_symbol() }} {{getAmount(strowalletBalance()['balance'],2) }}</h2>
                                </div>
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 mb-15">
                <div class="chart-wrapper">
                    <div class="chart-area-header">
                        ...
                        <a href="{{ setRoute('admin.virtual.card.logs') }}" class="btn--base  "> {{ __("View") }}</a>
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 mb-15">
                <div class="chart-wrapper">
                    <div class="chart-area-header">
                        ...
                        <div>
                            <a href="{{ url('/').'/admin/setup-sections/blog-section'}}" class="btn--base  ">{{ __( "View Blogs") }}</a>
                        </div>
                    </div>
                    <div class="chart-container">
